            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()){
                    case R.id.home:
                        ...
                        return true;
                    case R.id.search:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fl_wrapper, searchFragment).commit();
                        return true;
                    case R.id.edit:
                        getSupportFragmentManager().beginTransaction().replace(R.id.fl_wrapper, editFragment).commit();
                        return true;
                }
                return false;
